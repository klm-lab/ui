...
<ul>
<li>Switched from using smooth-scroll to <a href="https://github.com/zengabor/zenscroll">zenscroll</a> for reasons.. <a href="https://github.com/tscanlin/tocbot/issues/40">#40</a></li>
</ul>
...
</script></div></main></div></div><script id="__NEXT_DATA__" type="application/json">{"props":{"pageProps":{}},"page":"/changelog","query":{},"buildId":"thOYamuEniJXHH0F878r3","assetPrefix":"/tocbot","nextExport":true,"autoExport":true,"isFallback":false,"scriptLoader":[]}</script></body></html>